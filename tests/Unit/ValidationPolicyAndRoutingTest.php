...
/**
 * Covers the 1.2.0 flexibility features: ValidationPolicy, RouteClassifier,
 * the newly-enforced international restrictions (B2C services, returnable/
 * stackable packaging) and typed ValidationError.
 */
final class ValidationPolicyAndRoutingTest extends TestCase
{
    ...
    {
        $ex = new SuusValidationException(['legacy string error']);

        $this->assertSame(['legacy string error'], $ex->getErrors());
