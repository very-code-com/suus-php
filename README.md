...
[![Integration](https://github.com/very-code-com/suus-php/actions/workflows/integration.yml/badge.svg?branch=master)](https://github.com/very-code-com/suus-php/actions/workflows/integration.yml)
...
The integration workflow stays out of the pull-request gate: forks cannot read repository
secrets, and the addOrder tests register real sandbox orders, so it runs on a schedule and is
serialised through a concurrency group.
...
Built by [Very Code](https://very-code.com). Issues and pull requests are welcome.
