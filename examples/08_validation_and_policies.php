 ...
 * ---------------------------------------------------------------------------
 * Three flexibility features (since 1.2.0), none of which touch the network:
 *
...
echo "\nNotes:\n";
echo "- Option 3 changes what the LIBRARY sends (no <shipper>/<consignee>, no incoterms)\n";
echo "  and how it validates locally - but SUUS classifies routes on its OWN side from\n";
echo "  the address country codes. A DE->DE order is still an international product server-\n";
echo "  side and is rejected (BTN0002) unless your SUUS contract supports that treatment.\n";
echo "  For simply relaxing the local intl-only checks, prefer ValidationPolicy (option 2).\n";
