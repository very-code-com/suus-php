...
/**
 * Example 09 - Sandbox connectivity smoke test.
 * ---------------------------------------------------------------------------
 * Creates one real sandbox shipment and prints the full SOAP exchange, which is
 * the quickest way to check credentials and connectivity without running the
 * test suite. The transport below wraps CurlTransport purely to echo the raw
