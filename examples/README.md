...
| 09 | [`09_sandbox_smoke_test.php`](09_sandbox_smoke_test.php) | Connectivity smoke test: creates one sandbox shipment and prints the raw SOAP request/response | Yes (sandbox) |
