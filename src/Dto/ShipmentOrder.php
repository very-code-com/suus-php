 ...
 *   or plain SUUS service code strings for backward compatibility.
 *   e.g. [new CodService(500.00)] or ['RohligCOD'] (legacy).
 */
final class ShipmentOrder
{
    /**
     * @param Package[]                     $packages          At least one package required.
     * @param array<ServiceInterface|string> $additionalServices Optional typed service objects or legacy code strings.
     */
