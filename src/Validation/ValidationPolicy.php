 ...
 *
 * SUUS reserves several rules for international (non-domestic) orders — the
 * order must be B2B, B2C-only services (SMS pre-advice, inside delivery) are
 * unavailable, and returnable/stackable packaging is not allowed
 * (SUUS WebApi docs, WS PK 1.0). Those are enforced by DEFAULT (strict), but
 * which routes count as "international" for a given merchant/contract can differ
