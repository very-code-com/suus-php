...
final class SoapEnvelopeBuilder
{
     ...
     *
     * Accepts typed ServiceInterface objects (recommended) or plain service code strings
     * for backward compatibility. Plain strings produce a <symbol>-only service element.
     *
